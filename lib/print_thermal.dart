...
class TestPrint {
  ...
  printServiceKittir(String nim,String nama, String email, String jenisKelamin, String ttd,String pathImage,String pathImageTtd) async {
    ...
    String term3_1 = "   service center resmi pt hit; karena memiliki risiko reparasi";
    ...
    String term7_1 = "   identitas (npwp/ktp/paspor) dan tanda terima resmi pt hit";
    ...
    String term9_2 = "   ketentuan layanan service PT. HIT";
    bluetooth.isConnected.then((isConnected){
      if(isConnected){
        bluetooth.printImage(pathImage);
        bluetooth.printNewLine();
